...
describe("authenticate middleware", () => {
    ...
    it("should set role to null when token does not contain role", async () => {
        // Arrange
        mockRequest.headers = {
            authorization: "Bearer valid-token",
        };
    ...
    it("should handle Firebase auth errors with error codes", async () => {
        // Arrange
        mockRequest.headers = {
        ...
        (auth.verifyIdToken as jest.Mock).mockRejectedValueOnce(firebaseError);
